...
Under My Ubuntu 22.04.3 LTS VM, execute "gcc -o pro02 pro02.cpp" to test codes.

Show me these messages:

/usr/bin/ld: /tmp/cc9Hb9rt.o: warning: relocation against `_ZSt4cout' in read-only section `.text._ZN1X1fEi[_ZN1X1fEi]'
/usr/bin/ld: /tmp/cc9Hb9rt.o: in function `main':
...
/usr/bin/ld: /tmp/cc9Hb9rt.o: in function `__static_initialization_and_destruction_0(int, int)':
...
/usr/bin/ld: /tmp/cc9Hb9rt.o: in function `X::f(int)':
